...
ax1 = gca; ax1.FontSize = 11; ax1.FontName = 'Arial'; ax1.YTick = [];
ylabel('Climate state','FontName','Arial','FontSize',13,'FontWeight','bold')
xlabel('Age (Ma)','FontName','Arial','FontSize',13,'FontWeight','bold')
text(482,38,'A','FontName','Arial','FontSize',15,'FontWeight','bold','color','w')
...
for ii = 1:numel(fn)
    ...
    text(xtext(ii),ytext(ii),statelab(ii),'FontWeight','bold','FontName',...
        'Arial','FontSize',11,'HorizontalAlignment','center','Color',cm_font(ii,:))
    text(xtext(ii),ytext(ii)-.005,temptext,'FontName','Arial','FontSize',...
        11,'HorizontalAlignment','center','Color',cm_font(ii,:))
end
ylim([0 .072]),xlim([3 44])
ax2.FontName = 'Arial'; ax2.FontSize = 11;
xlabel(['GMST (',char(176),'C)'],'FontName','Arial','FontSize',13,...
    'FontWeight','bold')
ylabel('Density','FontName','Arial','FontSize',13,'FontWeight','bold')
text(3.75,.0695,'B','FontName','Arial','FontSize',15,'FontWeight','bold')
ax2.YTick = [0:.01:.06];
...
text(ax3a,1,.85,'C','FontName','Arial','FontSize',15,'FontWeight','bold')
ax3a.Visible = 'off';
% (e) Pie chart
...
ylabel(['Air temperature (',char(176),'C)'],'FontName','Arial','FontSize',13,'FontWeight','bold')
ylim([-50 46])
text(-86,41.25,'D','FontName','Arial','FontSize',15,'FontWeight','bold','color','k')
ax4.Color = 'none';
...
for ii = 1:numel(fn)
    ...
    text(xtext(ii),ytext(ii),statelab(ii),'FontWeight','bold','FontName',...
        'Arial','FontSize',11,'HorizontalAlignment','center','Color',cm_font(ii,:))
    text(xtext(ii),ytext(ii)-.0045,temptext,'FontName','Arial','FontSize',...
        11,'HorizontalAlignment','center','Color',cm_font(ii,:))
end
...
xlabel(['GMST (',char(176),'C)'],'FontName','Arial','FontSize',13,...
    'FontWeight','bold')
ylabel('Density','FontName','Arial','FontSize',13,'FontWeight','bold')
text(3.75,.0665,'B','FontName','Arial','FontSize',15,'FontWeight','bold')
% (d) Pie chart
...
ax4.FontSize = 11;
xlabel('Latitude','FontName','Arial','FontSize',13,'FontWeight','bold')
ylabel(['Air temperautre (',char(176),'C)'],'FontName','Arial','FontSize',13,'FontWeight','bold')
ylim([-50 46])
...
ylim(ax3b,[-1.7,1.1])
xlim(ax3b,[-1.3,1.3])
text(ax3b,-1.2,.8,'D','FontName','Arial','FontSize',15,'FontWeight','bold')

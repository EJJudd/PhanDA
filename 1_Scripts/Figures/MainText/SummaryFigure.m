...
patch([xx;flipud(xx)],[yy5;flipud(yy95)],...
    'w','FaceColor',[.9,.9,.9],'EdgeColor','none');
patch([xx;flipud(xx)],[yy10;flipud(yy90)],...
    'w','FaceColor',[.8,.8,.8],'EdgeColor','none');
patch([xx;flipud(xx)],[yy16;flipud(yy84)],...
    'w','FaceColor',[.7,.7,.7],'EdgeColor','none');
patch([xx;flipud(xx)],[yy25;flipud(yy75)],...
    'w','FaceColor',[.6,.6,.6],'EdgeColor','none');
patch([xx;flipud(xx)],[yy40;flipud(yy60)],...
